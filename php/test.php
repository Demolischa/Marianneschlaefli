...
$mailcontent .= "Bei Fragen oder Problemen steht Ihnen jederzeit unser Support zur Verfügung.\n\nFAQ Seite: https://www.kontaktformular.com/faq-script-php-kontakt-formular.html\nTutorial Seite: https://www.kontaktformular.com/kontaktformular-erstellen-tutorial.html\n";
		...
		if($success){
    		    echo "<div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 15px;color:green;margin-top:50px;font-weight:bold;'>Die Test-Mail wurde erfolgreich versandt.</div><br /><div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 15px;color:green;text-align:center;'>Sie sollten innerhalb der nächsten Sekunden eine E-Mail erhalten.</div>
		 
		 <br />
		 <div style='display: flex;align-items: center;justify-content: center;font-family: Arial, sans-serif;font-size: 15px;color:green;'> <a style='font-family: Arial, sans-serif;color:blue;text-decoration:underline;font-size: 15px;' target=_blank href=https://www.kontaktformular.com/faq-script-php-kontakt-formular.html#keine-mail-erhalten>Keine Mail erhalten? Bitte hier klicken!</a></div>";
            }
...
<body>
	...
	<div>
	<div style="padding: 1px 1rem 1px 1rem;margin-top:50px;width: auto;">Mit diesem Formular können Sie die PHP Funktion <b>mail()</b> auf Ihrem Server testen.<br /><br />Tragen Sie Ihre E-Mail Adresse ein und klicken Sie auf <b>Senden</b>.<br /><br /> Innerhalb von wenigen Sekunden sollten Sie eine Test-Mail erhalten.<br /><br />Diese Datei kann danach gelöscht werden.</div>
...
<div class="row">
				...
				<div>	<?php if ($fehler["email"] != "") { echo $fehler["email"]; } ?></div> <label class="label-field">Ihre E-Mail Adresse</label>
