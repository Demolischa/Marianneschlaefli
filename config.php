...
$empfaenger = "fitimschuh@gmx.ch";  // Bitte tragen Sie hier Ihre E-Mail Adresse ein. (zwischen den Anführungszeichen)
...
$cfg['Badwordfields'] = 'name, email, ort, telefon, betreff, nachricht';  //   Die Namen der Felder, die bei dem Bad Word Filter geprüft werden sollen - Groß- und Kleinschreibung beachten!
...
$cfg['Icons_aktivieren'] = 1;  //  0 = keine Icons    1 = mit Icons
