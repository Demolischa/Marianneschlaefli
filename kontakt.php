			...
			<div class="row checkbox-row <?php if ($fehler["datenschutz"] != "") { echo 'error_container'; } ?>">
				<div class="col-sm-8 <?php if ($fehler["datenschutz"] != "") { echo 'error'; } ?>">
					<label for="inlineCheckbox12" class="checkbox-inline">
						...
						<input style="<?php echo ($cfg['Icons_aktivieren'] ? 'left:55px;' : ''); ?>" type="checkbox" onclick="																		document.getElementById('dataprotection-checkbox-icon').innerHTML = (this.checked ? 'check_box' : 'check_box_outline_blank'); 
